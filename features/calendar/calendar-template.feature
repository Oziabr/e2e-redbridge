...
Scenario: Создание новой задачи
    ...
    And нажать на заголовок "Новая задача"
    And ввести в поле внутри заголовка значение "--тестовая-задача--"
...
Scenario: Создание новой встречи
    ...
    And нажать на заголовок "Новая встреча"
    And ввести в поле внутри заголовка значение "--тестовая-встреча--"
...
Scenario: Создание нового звонка
    ...
    And нажать на заголовок "Новый звонок"
    And ввести в поле внутри заголовка значение "--тестовый-звонок--"
