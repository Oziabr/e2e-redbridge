...
Scenario: Проверка возможности создания компании
    When нажать на кнопку "Создать"
    When wait "350"
...
Scenario: Проверка возможности создания пользователя
...
Scenario: Проверка возможности создания нового подразделения
...
Scenario: Проверка возможности создания нового товара
