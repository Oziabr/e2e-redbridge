...
Scenario: Создание договора со сделкой
    ...
    And в таблице есть строка c тесктом "--тестовый-договор--", чье значение равно "--тестовый-договор-- 30.11.2015 42 400 000,00 42 400 000,00 15 Авангард ТОО ООО Авангард"
