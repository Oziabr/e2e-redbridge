...
#     And ткнуть в меню второго уровня на "Документы поставки"
#     When wait "750"
#     And в таблице есть строка c тесктом "--тестовый-договор--", чье значение равно "--тестовый-договор-- 21.01.2016 42 400 000,00 42 400 000,00 15 Авангард ТОО ООО Авангард"
#     Then wait "750"
