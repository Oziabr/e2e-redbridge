...
Scenario: Создание договора со сделкой
    ...
    Then wait "250"
    When ткнуть в меню второго уровня на "Документы поставки"
    Then wait "250"
    ...
    And в таблице есть строка c тесктом "--тестовый-договор--", чье значение равно "--тестовый-договор-- 02.12.2015 42 400 000,00 42 400 000,00 15 Авангард ТОО ООО Авангард"
