...
Scenario: Создание нового пользовательского KPI [Временной горизонт]
    ...
    And нажать на кнопку "Создать и остаться в списке"
...
Scenario: Проверка наличия созданного KPI
    When в таблице есть строка c тесктом "уникальный-тестовый-идентификатор-шаблона", чье значение равно "уникальный-тестовый-идентификатор-шаблона [Временной горизонт]"
Examples:
    Временной горизонт
    Годовой
    Квартальный
