...
Scenario: Создание новой компании
    ...
    When wait "350"
    And ввести в поле внутри ярлыка, после "Название компании" значение "--тестовая-компания--"
...
Scenario: Поиск компании в фильтре
    ...
    When нажать на кнопку Поиск
    When нажать на результат поиска "--тестовая-компания--"
...
Scenario: Создание новой компании c заполнением карточки
    When нажать на кнопку Создать
    When wait "350"
    And ввести в поле внутри ярлыка, после "Название компании" значение "--тестовая-компания2--"
