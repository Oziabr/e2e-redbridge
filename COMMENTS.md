...
<!-- 22) Кнопка в карточке товара для вывода списком. -->

<!-- 23) Мои клиенты - Мои компании - Табы - кнопка Далее {cursor:text} поменять на {cursor:pointer} -->

<!-- 24) Планировщик встреч - Бэклог
Сползание блока вниз. -->
